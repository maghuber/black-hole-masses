...
python errorbars.py --slice1=0 --slice2=1000 --ndraws=500 --i='/scratch/alpine/mahu8801/blackhole_data/data/errors.dat' --o='/scratch/alpine/mahu8801/blackhole_data/data/1000draws.dat'