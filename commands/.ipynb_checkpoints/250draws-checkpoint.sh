...
python errorbars.py --all --ndraws=250 --i='/scratch/alpine/mahu8801/blackhole_data/data/largest_skew_100ngal.dat' --o='/scratch/alpine/mahu8801/blackhole_data/data/250draws.dat'